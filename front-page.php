			...
			<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>../assets/images/mora.jpg" alt="First slide">
			    </div>
			    <div class="carousel-item">
			      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>../assets/images/sendero.jpg" alt="First slide">
			    </div>
			    <div class="carousel-item">
			      <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>../assets/images/lampara.jpg" alt="First slide">
			    </div>
			  </div>
